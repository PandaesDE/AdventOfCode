...
public class Rock_Paper_Scissors {
    ...
    private static int getRoundResult(char a, char b) {
        ...
        switch (b) {
            case 'X':
                shapeScore = 1;
                if (a == 'A') outcomeScore = 3; 
                if (a == 'C') outcomeScore = 6; 
                break;
            case 'Y':
                shapeScore = 2;
                if (a == 'B') outcomeScore = 3;
                if (a == 'A') outcomeScore = 6;
                break;
            case 'Z':
                shapeScore = 3;
                if (a == 'C') outcomeScore = 3;
                if (a == 'B') outcomeScore = 6;
                break;
    ...
    private static int getTrueRoundResult(char a, char b) {
        ...
        switch (b) {
            case 'X': //LOSE
                outcomeScore = 0;
                if (a == 'A') shapeScore = 3;
                else if (a == 'B') shapeScore = 1;
                else shapeScore = 2;
                break;
            case 'Y': //DRAW
                outcomeScore = 3;
                if (a == 'A') shapeScore = 1;
                else if (a == 'B') shapeScore = 2;
                else shapeScore = 3;
                break;
            case 'Z': //WIN
                outcomeScore = 6;    
                if (a == 'A') shapeScore = 2;
                else if (a == 'B') shapeScore = 3;
                else shapeScore = 1;
                break;
